...
var StandardTooltipContent = function StandardTooltipContent(_ref2) {
  ...
  }, task.taskTitle), React.createElement("b", {
    className: styles$2.tooltipDate,
    style: {
      fontSize: fontSize + 6
    }
  }, task.start.getDate() + "  \n      " + monthName(task.start) + " \n      " + task.start.getFullYear() + " - " + task.end.getDate() + " " + monthName(task.end) + " " + task.end.getFullYear()), React.createElement("p", {
    className: styles$2.tooltipDescription
  }, task.taskDescription), React.createElement("button", {
    onClick: function onClick() {
      return handleEdit();
    },
  ...
  }, "Rediger")), React.createElement("div", {
...
var GridBody = function GridBody(_ref) {
  ...
  var startDay = React.createElement("line", null);
  var startDayText = React.createElement("text", null);
  var monthName = new Intl.DateTimeFormat("da-DA", {
    month: "long"
  }).format;
  ...
  for (var i = 0; i < dates.length; i++) {
    ...
    if (i + 1 !== dates.length && date.getTime() < now.getTime() && dates[i + 1].getTime() >= now.getTime() || i !== 0 && i + 1 === dates.length && date.getTime() < now.getTime() && addToDate(date, date.getTime() - dates[i - 1].getTime(), "millisecond").getTime() >= now.getTime()) {
      today = React.createElement("line", {
        strokeDasharray: "5,5",
        x1: tickX,
        y1: y,
        x2: tickX,
  ...
  var lastTick = React.createElement("line", {
    x1: tickX,
    y1: 0,
    x2: tickX,
    y2: y,
  ...
  }, startDay), React.createElement("g", {
    className: styles$4.startDayText
  }, startDayText), React.createElement("g", {
    className: "lastTick"
  }, lastTick));
};
...
var TaskGanttContent = function TaskGanttContent(_ref) {
  ...
  return React.createElement("g", {
    ...
    return task.type === "task" ? React.createElement(TaskItem, {
      task: task,
      arrowIndent: arrowIndent,
      taskHeight: taskHeight,
